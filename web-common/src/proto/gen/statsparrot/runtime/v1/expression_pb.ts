...
// @generated from file statsparrot/runtime/v1/expression.proto (package statsparrot.runtime.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum statsparrot.runtime.v1.Operation
 */
export enum Operation {
  ...
  /**
   * @generated from enum value: OPERATION_CAST = 13;
   */
  CAST = 13,
}
// Retrieve enum metadata with: proto3.getEnumType(Operation)
proto3.util.setEnumType(Operation, "statsparrot.runtime.v1.Operation", [
  ...
  { no: 13, name: "OPERATION_CAST" },
]);

/**
 * @generated from message statsparrot.runtime.v1.Expression
 */
export class Expression extends Message<Expression> {
  /**
   * @generated from oneof statsparrot.runtime.v1.Expression.expression
   */
  expression: {
    /**
    ...
    /**
     * @generated from field: statsparrot.runtime.v1.Condition cond = 3;
     */
    value: Condition;
    case: "cond";
  } | {
    /**
     * @generated from field: statsparrot.runtime.v1.Subquery subquery = 4;
     */
    value: Subquery;
    case: "subquery";
  ...
  static readonly typeName = "statsparrot.runtime.v1.Expression";
...
/**
 * @generated from message statsparrot.runtime.v1.Condition
 */
export class Condition extends Message<Condition> {
  /**
   * @generated from field: statsparrot.runtime.v1.Operation op = 1;
   */
  op = Operation.UNSPECIFIED;

  /**
   * @generated from field: repeated statsparrot.runtime.v1.Expression exprs = 2;
   */
  exprs: Expression[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.runtime.v1.Condition";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message statsparrot.runtime.v1.Subquery
 */
export class Subquery extends Message<Subquery> {
  ...
  /**
   * @generated from field: statsparrot.runtime.v1.Expression where = 3;
   */
  where?: Expression;

  /**
   * @generated from field: statsparrot.runtime.v1.Expression having = 4;
   */
  having?: Expression;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.runtime.v1.Subquery";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
