...
export class AgentService {
    ...
    constructor(sandboxProvider: ISandboxProvider, projectRepo: ProjectRepository) {
     ...
     */
    public async runDataProfilerAgent(tenantId: string, projectId: string, dataUri: string): Promise<void> {
...
`;
    ...
    private async saveGeneratedQueries(tenantId: string, projectId: string, queries: any[]): Promise<void> {
