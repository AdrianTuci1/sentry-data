...
// @generated from file statsparrot/admin/v1/internal.proto (package statsparrot.admin.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message statsparrot.admin.v1.StringPageToken
 */
export class StringPageToken extends Message<StringPageToken> {
  ...
  static readonly typeName = "statsparrot.admin.v1.StringPageToken";
...
/**
 * @generated from message statsparrot.admin.v1.StringTimestampPageToken
 */
export class StringTimestampPageToken extends Message<StringTimestampPageToken> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.admin.v1.StringTimestampPageToken";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
