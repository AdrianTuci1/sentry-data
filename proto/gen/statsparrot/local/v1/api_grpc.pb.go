...
const (
	LocalService_Ping_FullMethodName                                = "/statsparrot.local.v1.LocalService/Ping"
	LocalService_GetMetadata_FullMethodName                         = "/statsparrot.local.v1.LocalService/GetMetadata"
	LocalService_GetVersion_FullMethodName                          = "/statsparrot.local.v1.LocalService/GetVersion"
	LocalService_GitStatus_FullMethodName                           = "/statsparrot.local.v1.LocalService/GitStatus"
	LocalService_GithubRepoStatus_FullMethodName                    = "/statsparrot.local.v1.LocalService/GithubRepoStatus"
	LocalService_CreateGithubPullRequest_FullMethodName             = "/statsparrot.local.v1.LocalService/CreateGithubPullRequest"
	LocalService_GetGithubPullRequest_FullMethodName                = "/statsparrot.local.v1.LocalService/GetGithubPullRequest"
	LocalService_GitPull_FullMethodName                             = "/statsparrot.local.v1.LocalService/GitPull"
	LocalService_GitPush_FullMethodName                             = "/statsparrot.local.v1.LocalService/GitPush"
	LocalService_PushToGithub_FullMethodName                        = "/statsparrot.local.v1.LocalService/PushToGithub"
	LocalService_DeployProject_FullMethodName                       = "/statsparrot.local.v1.LocalService/DeployProject"
	LocalService_RedeployProject_FullMethodName                     = "/statsparrot.local.v1.LocalService/RedeployProject"
	LocalService_GetCurrentUser_FullMethodName                      = "/statsparrot.local.v1.LocalService/GetCurrentUser"
	LocalService_GetCurrentProject_FullMethodName                   = "/statsparrot.local.v1.LocalService/GetCurrentProject"
	LocalService_ListOrganizationsAndBillingMetadata_FullMethodName = "/statsparrot.local.v1.LocalService/ListOrganizationsAndBillingMetadata"
	LocalService_CreateOrganization_FullMethodName                  = "/statsparrot.local.v1.LocalService/CreateOrganization"
	LocalService_ListMatchingProjects_FullMethodName                = "/statsparrot.local.v1.LocalService/ListMatchingProjects"
	LocalService_ListProjectsForOrg_FullMethodName                  = "/statsparrot.local.v1.LocalService/ListProjectsForOrg"
	LocalService_GetProject_FullMethodName                          = "/statsparrot.local.v1.LocalService/GetProject"
)
...
var LocalService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "statsparrot.local.v1.LocalService",
	...
	Metadata: "statsparrot/local/v1/api.proto",
}
