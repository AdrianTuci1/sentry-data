 ...
 * Parrot Admin API
 * Parrot Admin API enables programmatic management of Parrot Cloud resources, including organizations, projects, and user access. It provides endpoints for creating, updating, and deleting these resources, as well as managing authentication and permissions.
...
export type AdminServiceListProjectsForFingerprintParams = {
  ...
  gitRemote?: string;
  subPath?: string;
  statsparrotMgdGitRemote?: string;
};
