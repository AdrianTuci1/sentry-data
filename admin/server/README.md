...
2. **UI Redirection**: `redirect` field is used to store the redirect url sent in the original installation request. This is mainly used by UI based deploy in statsparrot developer to continue deploy process in the browser.
