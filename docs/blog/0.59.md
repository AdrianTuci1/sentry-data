...
# Parrot 0.59 - Re-ordering of timeseries and leaderboards and new dashboard properties!
...
![release-0 59](<https://cdn.statsparrot.com/docs/release-notes/release-059.gif>)
...
In subsequent releases of Parrot, we will also remember your choices so you don't have to re-order them on every visit.
...
- Fixed various bugs, UX improvements, and new features around Canvas dashboards:
  ...
  - Updated URL paths
  - Removed components from Parrot Cloud's Status page
  - Image alignment
  - Flat table
...
- Always show OLAP engine option in Parrot Developer
...
- Fixed issue in Parrot Developer where model references were not tracked properly
