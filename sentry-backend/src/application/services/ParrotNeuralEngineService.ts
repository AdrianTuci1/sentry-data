    ...
    public async compileProjectionPlan(runtimeState: ParrotRuntimeState): Promise<ParrotProjectionPlan> {
        ...
        const response = await fetch(this.resolveApiUrl('compile_projection_plan'), {
            ...
            body: JSON.stringify({
                ...
                previousProjectionRegistry: runtimeState.previousProjectionRegistry,
                previousQueryRegistry: runtimeState.previousQueryRegistry,
                invalidationHints: runtimeState.invalidationHints,
                sentinelPolicyState: runtimeState.sentinelPolicyState,
                activeProjectionVersions: runtimeState.activeProjectionVersions,
                widgetCatalogVersion: runtimeState.widgetCatalogVersion,
                forceRediscover: runtimeState.forceRediscover,
                invalidatedSources: runtimeState.invalidatedSources,
