...
# Parrot 0.83 - Canvas Generation, Supabase Connector, Project Table Information
...
![release-0.83](<https://cdn.statsparrot.com/docs/release-notes/release-083.gif>)
...
We've added a new Supabase connector, making it easy to connect to your Supabase database and bring that data into Parrot.

## Project Status Tables Page

The project status page now includes a dedicated Tables tab, giving you visibility into the tables in your OLAP database directly from the Parrot Cloud UI.
...
- `statsparrot init` now prompts for template if not provided
