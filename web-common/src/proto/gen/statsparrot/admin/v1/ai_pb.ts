...
// @generated from file statsparrot/admin/v1/ai.proto (package statsparrot.admin.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message statsparrot.admin.v1.CompleteRequest
 */
export class CompleteRequest extends Message<CompleteRequest> {
  /**
   * Input message(s) for the AI to complete.
   *
   * @generated from field: repeated statsparrot.ai.v1.CompletionMessage messages = 1;
   */
   ...
   *
   * @generated from field: repeated statsparrot.ai.v1.Tool tools = 2;
   */
  tools: Tool[] = [];
  ...
  static readonly typeName = "statsparrot.admin.v1.CompleteRequest";
...
/**
 * @generated from message statsparrot.admin.v1.CompleteResponse
 */
export class CompleteResponse extends Message<CompleteResponse> {
  /**
   * The AI-generated output message.
   *
   * @generated from field: statsparrot.ai.v1.CompletionMessage message = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.admin.v1.CompleteResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
