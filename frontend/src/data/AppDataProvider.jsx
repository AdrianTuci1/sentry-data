 ...
 *
 * Mounts the TanStack React QueryClientProvider (required by the ported Parrot leaf
 * components — MeasureBigNumber, Leaderboard, DimensionTable, PivotTable and the
 * dashboard filters/time-controls — which call `useQuery`) around Parrot's
 ...
 * BI UI to the live Parrot runtime (see data/dataSource.js for how the host/instance
