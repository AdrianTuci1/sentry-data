...
# Parrot 0.85 - Snowflake Live Connector, First Mile Flow, Preview Mode
...
![release-0.85](<https://cdn.statsparrot.com/docs/release-notes/release-0.85.gif>)

## Snowflake Live Connector

You can now create metrics views directly on Snowflake via the new live connector, expanding Parrot's OLAP support beyond ClickHouse and DuckDB.

## Improved First Mile Experience

The onboarding experience has been improved to make getting started with Parrot smoother and more guided.

## Preview Mode for Parrot Developer
...
- Nicer hints and errors in `statsparrot query`
