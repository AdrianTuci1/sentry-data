...
![release-0 73](<https://cdn.statsparrot.com/docs/release-notes/073.png>)

## Introducing AI Agents for Parrot

We've been working hard over the last couple of months to bring an agentic AI workflow to Parrot. Building on our existing MCP (Model Context Protocol) server integration, we're now introducing project-wide chat in Parrot, which is our first interactive agent of many to come.
...
### Parrot Time Fixes and Improvements

- **Added offset statsparrot time syntax** - Support for time offset operations in queries
