import { RuntimeClientProvider } from '@statsparrot/web-common/runtime-client/react';
import { resolveRuntimeConfig } from '@/data/dataSource';
import { useRuntimeTenancy } from '@/services/RuntimeTenancy';

/**
 * Wraps the React app in the Parrot runtime-client <RuntimeClientProvider>, wiring
 ...
 * (data/dataSource.js) supplies the default: the local `statsparrot start` runtime at
