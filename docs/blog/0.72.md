...
# Parrot 0.72 – We reinvented Time
...
- **Parrot-time frontend parser improvements**: Enhanced time parsing capabilities
...
- **Project refresh enhancements**: Added `--connector` option to statsparrot project refresh
