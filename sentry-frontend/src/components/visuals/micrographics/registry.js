...
import {
    ...
    LeadsList,
    LiquidGauge,
    MatplotlibAttentionHeatmap,
    MatplotlibBenchmarkBars,
    MatplotlibTrainingPanel,
    LiveTrafficChart,
    MarketEvolution,
...
const componentRegistryByType = {
    ...
    'mpl-attention-heatmap': MatplotlibAttentionHeatmap,
    'mpl-benchmark-bars': MatplotlibBenchmarkBars,
    'mpl-training-loss': MatplotlibTrainingPanel,
    'market-evolution': MarketEvolution,
    'market-radar': MarketSentimentRadar,
    'metric-trend': MetricTrendMicro,
    ...
    'signal-scale': SignalScaleMicro,
    'sparkline-stat': SparklineStatMicro,
    'stream-graph': StreamGraph,
    'technical-health': TechnicalHealth,
    'trend-spotter': TrendSpotter,
    'uptime-strip': UptimeStripMicro,
