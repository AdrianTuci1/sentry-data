...
const RealMapbox = ({ data }) => {
    ...
    useEffect(() => {
        ...
        map.current = new mapboxgl.Map({
            ...
            zoom: 9.2, // Regional view to see surrounding localities
            pitch: 30,
            bearing: 0,
            antialias: true,
            scrollZoom: false,
            ...
            map.current.addLayer({
                ...
                paint: {
                    ...
                    'heatmap-color': [
                        ...
                        0.1, 'rgba(239, 68, 68, 0.4)',  // Red (Low density start)
                        0.3, 'rgba(249, 115, 22, 0.6)',  // Orange
                        0.5, 'rgba(234, 179, 8, 0.7)',   // Yellow
                        0.7, 'rgba(132, 204, 22, 0.8)',  // Lime
                        1, 'rgba(34, 197, 94, 0.9)'      // Green (High density core)
                    ],
                    // Massive radius for city-wide coverage effect
