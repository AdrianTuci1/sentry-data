---
title: Building Your Data Analytics Pipeline in Parrot
sidebar_label: Build
sidebar_position: 0
---

Parrot provides a comprehensive platform for building end-to-end data analytics solutions. Once you've connected to your source data or connected to your own OLAP database, you can start building with Parrot. Don't forget to check out the [reference documentation!](/reference/project-files)

### What is a Parrot project?
- [**Getting Started with your Parrot Project**](/developers/build/getting-started) - Understand Parrot project structure and configuration

### Connect to your Data
- [**Connectors Overview**](/developers/build/connectors) - Learn about connecting Parrot to data sources and OLAP engines
...
- [**Models Overview**](/developers/build/models) - Overview of models available in Parrot
...
- [**Time Series**](/developers/build/metrics-view/time-series) - The backbone of Parrot Explore Dashboards, time
...
- [**Dashboards Types**](/developers/build/dashboards/dashboards-101) - What are the visualization options in Parrot, and how are they different?
...
- [**Custom APIs Overview**](/developers/build/custom-apis) - Create HTTP API endpoints to expose your Parrot data
...
### Project Settings
- [**Project Configuration**](/developers/build/project-configuration) - Configure your Parrot Project and set default behavior
- [**Structure your Project**](/developers/build/structure) - Structure folder architecture in Parrot
- [**Use your favorite IDE**](/developers/build/ide) - Utilize your favorite IDE to build Parrot projects
- [**Debugging Parrot Developer**](/developers/build/debugging/trace-viewer) - Troubleshoot dashboard access, trace your reconciled resources, and understand project logs
