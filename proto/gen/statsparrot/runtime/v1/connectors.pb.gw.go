...
func RegisterConnectorServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ConnectorServiceServer) error {
	...
	mux.Handle("GET", pattern_ConnectorService_ListBuckets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/ListBuckets", runtime.WithHTTPPathPattern("/v1/instances/{instance_id}/connectors/{connector}/buckets"))
		if err != nil {
	...
	mux.Handle("GET", pattern_ConnectorService_ListObjects_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/ListObjects", runtime.WithHTTPPathPattern("/v1/instances/{instance_id}/connectors/{connector}/buckets/{bucket}/objects"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_OLAPListTables_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/OLAPListTables", runtime.WithHTTPPathPattern("/v1/olap/tables"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_OLAPGetTable_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/OLAPGetTable", runtime.WithHTTPPathPattern("/v1/connectors/olap/table"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_ListDatabaseSchemas_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/ListDatabaseSchemas", runtime.WithHTTPPathPattern("/v1/connectors/database_schemas"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_ListTables_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/ListTables", runtime.WithHTTPPathPattern("/v1/connectors/tables"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_GetTable_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/GetTable", runtime.WithHTTPPathPattern("/v1/connectors/table_metadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterConnectorServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ConnectorServiceClient) error {
	...
	mux.Handle("GET", pattern_ConnectorService_ListBuckets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/ListBuckets", runtime.WithHTTPPathPattern("/v1/instances/{instance_id}/connectors/{connector}/buckets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_ListObjects_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/ListObjects", runtime.WithHTTPPathPattern("/v1/instances/{instance_id}/connectors/{connector}/buckets/{bucket}/objects"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_OLAPListTables_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/OLAPListTables", runtime.WithHTTPPathPattern("/v1/olap/tables"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_OLAPGetTable_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/OLAPGetTable", runtime.WithHTTPPathPattern("/v1/connectors/olap/table"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_ListDatabaseSchemas_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/ListDatabaseSchemas", runtime.WithHTTPPathPattern("/v1/connectors/database_schemas"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_ListTables_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/ListTables", runtime.WithHTTPPathPattern("/v1/connectors/tables"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorService_GetTable_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/statsparrot.runtime.v1.ConnectorService/GetTable", runtime.WithHTTPPathPattern("/v1/connectors/table_metadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
