...
This guide walks you through the Cost Monitoring Analytics demo project, which showcases Parrot's capabilities for analyzing cost and usage data. You'll learn how to clone the project, understand its structure, and explore the dashboard.

## Overview

This dataset is modeled after a similar dashboard we use internally at Parrot to both identify opportunities to improve our cloud infrastructure operations and to manage customer implementations. Typical users include engineering, customer success, and finance. In this example, we've combined cloud services, other hosting costs, and revenue metrics.
...
cd statsparrot-examples/statsparrot-cost-monitoring
```
...
```yaml
# Visit https://docs.statsparrot.com/ to learn more about Parrot code artifacts.
type: source
connector: "https"
uri: "https://storage.googleapis.com/statsparrot-public/metrics_margin_monitoring.parquet"
```
...
- Ingests the data into Parrot's OLAP Engine (DuckDB)
...
## Step 4: Data Models
:::tip Modeling
In our example, we've already processed the data, but if you need to do some last-mile ETL in Parrot, this is possible via a [model](/developers/build/models).
:::


## Step 5: Creating your Metrics View

Metrics in Parrot define the measures and dimensions that power your margin monitoring dashboards:
