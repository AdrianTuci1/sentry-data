...
# Parrot 0.82 - AI Feedback, AI in Canvas, New Status page and Scatter Plot
...
![release-0.82](<https://cdn.statsparrot.com/docs/release-notes/release-082.gif>)

## AI Feedback

You can now give thumbs up and thumbs down to score your conversations with Parrot's AI agent. This helps it learn and provide even better and more crisp answers for you and your colleagues in future chats.
...
We have massively overhauled the status page for projects within Parrot Cloud. You can now easily search, filter, and find resources—for example, those that are erroring—as well as get full access to logs without having to use the CLI.
...
We're proud to introduce the ability to export data from Parrot on a continuous basis. You can now set up scheduled exports of models to object storage such as S3 and GCS, exporting models from Parrot as parquet files for downstream processing.
...
### Parrot Developer
- Root cause errors are now surfaced in Parrot Developer
- Hidden share conversation button in Parrot Developer
...
- Fixed Parrot logo display when forced to dark mode
