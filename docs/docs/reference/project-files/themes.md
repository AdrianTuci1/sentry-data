...
In your Parrot project directory, create a `<theme_name>.yaml` file in any directory containing `type: theme`. Parrot will automatically ingest the theme next time you run `statsparrot start` or deploy to Parrot Cloud.
