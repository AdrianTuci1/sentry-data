...
import { SentinelCoreRuntimeAdapter } from './SentinelCoreRuntimeAdapter';
...
export class BusinessRelevanceModel {
    private readonly sentinelCore = new SentinelCoreRuntimeAdapter();

    public evaluate(querySpecs: ParrotQuerySpec[] = [], sourceProfiles: ParrotSourceProfile[] = []): SentinelRuntimeEvaluation {
        return this.sentinelCore.evaluateBusinessRelevance(querySpecs, sourceProfiles);
    }
}
