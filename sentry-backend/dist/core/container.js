...
function initContainer() {
    ...
    const analyticsService = new AnalyticsService_1.AnalyticsService(projectRepo, widgetService, widgetRenderer);
    ...
    const bronzeDiscoveryService = new BronzeDiscoveryService_1.BronzeDiscoveryService(r2StorageService);
    ...
    const orchestrationService = new OrchestrationService_1.OrchestrationService(projectRepo, sseManager, parrotRuntimeService, bronzeDiscoveryService, mindMapManifestService, parrotProgressService, workloadPlannerService, executionPlaneService);
    ...
    const projectController = new ProjectController_1.ProjectController(orchestrationService, analyticsService, authService, projectRepo, sourceRepo);
    const controllers = [
        healthController,
        dashboardController,
        sseController,
