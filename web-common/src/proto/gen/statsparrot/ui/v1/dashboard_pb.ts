...
// @generated from file statsparrot/ui/v1/dashboard.proto (package statsparrot.ui.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message statsparrot.ui.v1.DashboardState
 */
export class DashboardState extends Message<DashboardState> {
  /**
   * Selected time range
   *
   * @generated from field: statsparrot.ui.v1.DashboardTimeRange time_range = 1;
   */
   ...
   *
   * @generated from field: statsparrot.runtime.v1.MetricsViewFilter filters = 2;
   */
   ...
   *
   * @generated from field: statsparrot.runtime.v1.Expression where = 20;
   */
  where?: Expression;
   ...
   *
   * @generated from field: repeated statsparrot.ui.v1.DashboardDimensionFilter having = 21;
   */
   ...
   *
   * @generated from field: statsparrot.runtime.v1.TimeGrain time_grain = 3;
   */
  timeGrain = TimeGrain.UNSPECIFIED;

  /**
   * @generated from field: statsparrot.ui.v1.DashboardTimeRange compare_time_range = 4;
   */
   ...
   *
   * @generated from field: statsparrot.ui.v1.DashboardState.ActivePage active_page = 32;
   */
  ...
  /**
   * @generated from field: optional statsparrot.ui.v1.DashboardState.LeaderboardContextColumn leaderboard_context_column = 12;
   */
   ...
   * Scrub time range
   *
   * @generated from field: optional statsparrot.ui.v1.DashboardTimeRange scrub_range = 14;
   */
  scrubRange?: DashboardTimeRange;

  /**
   * @generated from field: optional statsparrot.ui.v1.DashboardState.LeaderboardSortDirection leaderboard_sort_direction = 15;
   */
  leaderboardSortDirection?: DashboardState_LeaderboardSortDirection;

  /**
   * @generated from field: optional statsparrot.ui.v1.DashboardState.LeaderboardSortType leaderboard_sort_type = 16;
   */
   ...
   *
   * @generated from field: repeated statsparrot.runtime.v1.TimeGrain pivot_row_time_dimensions = 23;
   */
  ...
  /**
   * @generated from field: repeated statsparrot.runtime.v1.TimeGrain pivot_column_time_dimensions = 25;
   */
   ...
   * Sort settings
   *
   * @generated from field: repeated statsparrot.ui.v1.PivotColumnSort pivot_sort = 29;
   */
  ...
  /**
   * @generated from field: optional statsparrot.ui.v1.DashboardState.PivotTableMode pivot_table_mode = 31;
   */
   ...
   *
   * @generated from field: repeated statsparrot.ui.v1.PivotElement pivot_row_all_dimensions = 35;
   */
   ...
   *
   * @generated from field: repeated statsparrot.ui.v1.PivotElement pivot_column_all_dimensions = 36;
   */
   ...
   *
   * @generated from field: repeated statsparrot.ui.v1.PivotConditionalFormat pivot_conditional_formatting = 44;
   */
  ...
  static readonly typeName = "statsparrot.ui.v1.DashboardState";
...
/**
 * @generated from enum statsparrot.ui.v1.DashboardState.LeaderboardContextColumn
 */
...
proto3.util.setEnumType(DashboardState_LeaderboardContextColumn, "statsparrot.ui.v1.DashboardState.LeaderboardContextColumn", [
...
/**
 * @generated from enum statsparrot.ui.v1.DashboardState.LeaderboardSortDirection
 */
...
proto3.util.setEnumType(DashboardState_LeaderboardSortDirection, "statsparrot.ui.v1.DashboardState.LeaderboardSortDirection", [
 ...
 *
 * @generated from enum statsparrot.ui.v1.DashboardState.LeaderboardSortType
 */
...
proto3.util.setEnumType(DashboardState_LeaderboardSortType, "statsparrot.ui.v1.DashboardState.LeaderboardSortType", [
...
/**
 * @generated from enum statsparrot.ui.v1.DashboardState.PivotTableMode
 */
...
proto3.util.setEnumType(DashboardState_PivotTableMode, "statsparrot.ui.v1.DashboardState.PivotTableMode", [
...
/**
 * @generated from enum statsparrot.ui.v1.DashboardState.ActivePage
 */
...
proto3.util.setEnumType(DashboardState_ActivePage, "statsparrot.ui.v1.DashboardState.ActivePage", [
...
/**
 * @generated from message statsparrot.ui.v1.DashboardTimeRange
 */
export class DashboardTimeRange extends Message<DashboardTimeRange> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.ui.v1.DashboardTimeRange";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message statsparrot.ui.v1.DashboardDimensionFilter
 */
export class DashboardDimensionFilter extends Message<DashboardDimensionFilter> {
  ...
  /**
   * @generated from field: statsparrot.runtime.v1.Expression filter = 2;
   */
  filter?: Expression;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.ui.v1.DashboardDimensionFilter";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message statsparrot.ui.v1.PivotColumnSort
 */
export class PivotColumnSort extends Message<PivotColumnSort> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.ui.v1.PivotColumnSort";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message statsparrot.ui.v1.PivotElement
 */
export class PivotElement extends Message<PivotElement> {
  /**
   * @generated from oneof statsparrot.ui.v1.PivotElement.element
   */
  element: {
    /**
     * @generated from field: statsparrot.runtime.v1.TimeGrain pivot_time_dimension = 1;
     */
    value: TimeGrain;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.ui.v1.PivotElement";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message statsparrot.ui.v1.PivotConditionalFormat
 */
export class PivotConditionalFormat extends Message<PivotConditionalFormat> {
   ...
   *
   * @generated from field: repeated statsparrot.ui.v1.PivotFormatRule rules = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.ui.v1.PivotConditionalFormat";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message statsparrot.ui.v1.PivotFormatRule
 */
export class PivotFormatRule extends Message<PivotFormatRule> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.ui.v1.PivotFormatRule";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
