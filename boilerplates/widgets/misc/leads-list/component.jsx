...
const LeadsList = ({ data = {}, isMock = false }) => {
    const leads = (Array.isArray(data.leads) && data.leads.length > 0 ? data.leads : null) || 
    ...
    return (
        <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', gap: '14px', padding: '10px 0', overflowY: 'auto' }}>
            {leads.map((lead, i) => (
                <div key={i} style={{
                    display: 'flex',
