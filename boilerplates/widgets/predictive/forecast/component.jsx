...
const PredictiveForecast = ({ data = {}, isMock = false }) => {
    const historical = (Array.isArray(data.historical) && data.historical.length > 0 ? data.historical : null) || 
                       (Array.isArray(data.data?.historical) && data.data?.historical.length > 0 ? data.data.historical : null) || 
                       [320, 335, 310, 350, 380, 370, 400];
                       
    const forecast = (Array.isArray(data.forecast) && data.forecast.length > 0 ? data.forecast : null) || 
                     (Array.isArray(data.data?.forecast) && data.data?.forecast.length > 0 ? data.data.forecast : null) || 
                     [410, 425, 440, 435, 452];
