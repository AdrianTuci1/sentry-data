ALTER TABLE magic_auth_tokens ADD COLUMN resource_type TEXT NOT NULL DEFAULT 'statsparrot.runtime.v1.Explore';
...
UPDATE bookmarks SET resource_kind = 'statsparrot.runtime.v1.Explore' WHERE resource_kind = 'statsparrot.runtime.v1.MetricsView';
