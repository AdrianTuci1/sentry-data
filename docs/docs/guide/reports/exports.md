...
## Exporting from Parrot

There are several places to export your data from Parrot. In each case, you will see options for exporting to CSV, XLSX, or Parquet formats.
