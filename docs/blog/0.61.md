...
# Parrot 0.61 - Pie, Donut, and Heatmap Charts and remembering where you last were! 👀
...
![release-0 61](<https://cdn.statsparrot.com/docs/release-notes/release-061.gif>)
...
We’ve updated how deployed Parrot dashboards load in Parrot Cloud. Dashboards will now prioritize restoring the state you last used, while still respecting developer-defined configurations.
...
- Re-validate metrics view on external tables on `statsparrot project refresh`.
