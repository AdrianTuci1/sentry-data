...
// @generated from file statsparrot/ai/v1/ai.proto (package statsparrot.ai.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message statsparrot.ai.v1.Tool
 */
export class Tool extends Message<Tool> {
  ...
  static readonly typeName = "statsparrot.ai.v1.Tool";
 ...
 *
 * @generated from message statsparrot.ai.v1.ToolCall
 */
export class ToolCall extends Message<ToolCall> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.ai.v1.ToolCall";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message statsparrot.ai.v1.ToolResult
 */
export class ToolResult extends Message<ToolResult> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.ai.v1.ToolResult";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message statsparrot.ai.v1.ContentBlock
 */
export class ContentBlock extends Message<ContentBlock> {
  /**
   * @generated from oneof statsparrot.ai.v1.ContentBlock.block_type
   */
  blockType: {
    /**
    ...
    /**
     * @generated from field: statsparrot.ai.v1.ToolCall tool_call = 2;
     */
    value: ToolCall;
    case: "toolCall";
  } | {
    /**
     * @generated from field: statsparrot.ai.v1.ToolResult tool_result = 3;
     */
    value: ToolResult;
    case: "toolResult";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.ai.v1.ContentBlock";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message statsparrot.ai.v1.CompletionMessage
 */
export class CompletionMessage extends Message<CompletionMessage> {
  ...
  /**
   * @generated from field: repeated statsparrot.ai.v1.ContentBlock content = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.ai.v1.CompletionMessage";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
