...
title: statsparrot project connect-github
---
## statsparrot project connect-github

Deploy project to Parrot Cloud by pulling project files from a git repository

```
statsparrot project connect-github [<path>] [flags]
```
