export const VIEW_TEMPLATES = {
  ...
  financial: {
    ...
    widgets: [
      ...
      { id: 'orders-timeseries', type: 'bar-chart', size: '4x2', title: 'Orders Over Time', intent: 'orders over time' },
      ...
      { id: 'tax-estimate', type: 'record-list', size: '2x2', title: 'Corporate Tax Estimate', intent: 'upcoming tax payment estimate' },
      { id: 'needs-attention', type: 'record-list', size: '2x2', title: 'Needs Attention', intent: 'financial issues requiring action' },
  ...
  sales: {
    ...
    widgets: [
      ...
      { id: 'sales-overview', type: 'bar-chart', size: '4x2', title: 'Revenue Trend', intent: 'sales revenue trend over time' },
      { id: 'orders-series', type: 'bar-chart', size: '4x2', title: 'Orders Trend', intent: 'sales orders trend over time' },
      { id: 'aov-series', type: 'bar-chart', size: '4x2', title: 'AOV Trend', intent: 'average order value trend over time' },
      { id: 'conversion-series', type: 'bar-chart', size: '4x2', title: 'Conversion Trend', intent: 'conversion rate trend over time' },
      { id: 'lead-sources', type: 'pie-chart', size: '2x2', title: 'Lead Sources', intent: 'lead source distribution' },
      { id: 'new-leads', type: 'sparkline', size: '2x2', title: 'New Leads / Day', intent: 'new leads over time' },
      { id: 'campaign-roi', type: 'bar-chart', size: '2x2', title: 'Campaign ROI', intent: 'campaign return on ad spend' },
      { id: 'sales-transactions', type: 'record-list', size: '4x2', title: 'Recent Transactions', intent: 'recent sales transactions' },
    ],
  },
  marketing: {
    ...
    widgets: [
      ...
      { id: 'peak-hours', type: 'bar-chart', size: '4x1', title: 'Peak Hours', intent: 'peak campaign or traffic hours by volume' },
    ],
  },
};
