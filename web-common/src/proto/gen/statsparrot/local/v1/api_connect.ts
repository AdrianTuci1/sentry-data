...
/**
 * @generated from service statsparrot.local.v1.LocalService
 */
export const LocalService = {
  typeName: "statsparrot.local.v1.LocalService",
  methods: {
    /**
     * Ping returns the current time.
     *
     * @generated from rpc statsparrot.local.v1.LocalService.Ping
     */
    ping: {
      name: "Ping",
      I: PingRequest,
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.GitStatus
     */
    gitStatus: {
      name: "GitStatus",
      I: GitStatusRequest,
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.GithubRepoStatus
     */
    githubRepoStatus: {
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.CreateGithubPullRequest
     */
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.GetGithubPullRequest
     */
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.GitPull
     */
    gitPull: {
      name: "GitPull",
      I: GitPullRequest,
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.GitPush
     */
    gitPush: {
      name: "GitPush",
      I: GitPushRequest,
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.PushToGithub
     */
    pushToGithub: {
      name: "PushToGithub",
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.RedeployProject
     */
    redeployProject: {
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.GetCurrentUser
     */
    getCurrentUser: {
      name: "GetCurrentUser",
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.ListOrganizationsAndBillingMetadata
     */
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.CreateOrganization
     */
    createOrganization: {
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.ListMatchingProjects
     */
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.ListProjectsForOrg
     */
    listProjectsForOrg: {
     ...
     *
     * @generated from rpc statsparrot.local.v1.LocalService.GetProject
     */
    getProject: {
      name: "GetProject",
      I: GetProjectRequest,
