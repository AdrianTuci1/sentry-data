...
# Parrot 0.37 - Time Dimension Detail and Scheduled Reports! 🔥
...
![release-0 37](https://cdn.statsparrot.com/docs/release-notes/release_37_gif)

At Parrot, our vision has always been to create the fastest and most insightful dashboards.
...
Parrot's innovative Time Dimension Detail View for the dashboard is designed to enhance data analysis and comparison over time. Key features of this new view include:
