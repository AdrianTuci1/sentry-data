...
// @generated from file statsparrot/admin/v1/telemetry.proto (package statsparrot.admin.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message statsparrot.admin.v1.RecordEventsRequest
 */
export class RecordEventsRequest extends Message<RecordEventsRequest> {
  ...
  static readonly typeName = "statsparrot.admin.v1.RecordEventsRequest";
...
/**
 * @generated from message statsparrot.admin.v1.RecordEventsResponse
 */
export class RecordEventsResponse extends Message<RecordEventsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.admin.v1.RecordEventsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
