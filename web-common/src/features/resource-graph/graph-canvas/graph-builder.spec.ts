...
describe("build-resource-graph", () => {
  ...
  describe("buildResourceGraph", () => {
    it("should create nodes for allowed resource kinds", () => {
      ...
      expect(nodes.map((n) => n.id)).toEqual([
        "statsparrot.runtime.v1.Source:source1",
        "statsparrot.runtime.v1.Model:model1",
        "statsparrot.runtime.v1.MetricsView:metrics1",
        "statsparrot.runtime.v1.Explore:explore1",
      ]);
    });
    ...
    it("should filter out hidden resources", () => {
      ...
      expect(nodes[0].id).toBe("statsparrot.runtime.v1.Model:visible");
    });
    ...
    it("should create edges based on resource refs", () => {
      ...
      expect(edges[0].source).toBe("statsparrot.runtime.v1.Source:source1");
      expect(edges[0].target).toBe("statsparrot.runtime.v1.Model:model1");
    });
    ...
    it("should handle multiple refs per resource", () => {
      ...
      expect(edges.map((e) => e.source)).toEqual([
        "statsparrot.runtime.v1.Source:source1",
        "statsparrot.runtime.v1.Source:source2",
      ]);
    });
    ...
    it("should handle resources with incomplete meta", () => {
      ...
      expect(nodes).toHaveLength(1);
      expect(nodes[0].id).toBe("statsparrot.runtime.v1.Model:valid");
    });
  ...
  describe("partitionResourcesBySeeds", () => {
    it("should create single group from single seed", () => {
      ...
      expect(groups[0].id).toBe("statsparrot.runtime.v1.Model:model1");
    ...
    it("should create separate groups for multiple seeds", () => {
      ...
      const groups = partitionResourcesBySeeds(resources, [
        "statsparrot.runtime.v1.Model:model1",
        "statsparrot.runtime.v1.Model:model2",
      ]);
    ...
    it("should handle seed that doesn't exist", () => {
      ...
      const groups = partitionResourcesBySeeds(resources, [
        "statsparrot.runtime.v1.Model:nonexistent",
      ]);
    ...
    it("should deduplicate seed identifiers", () => {
      ...
      const groups = partitionResourcesBySeeds(resources, [
        "statsparrot.runtime.v1.Model:model1",
        "statsparrot.runtime.v1.Model:model1", // Duplicate
      ]);
