...
# Parrot 0.68 – Edit exported data columns in Reports, Time pills in Pivot, Schedule Alerts and Custom Sort Order in Canvas!
...
![release-0 68](<https://cdn.statsparrot.com/docs/release-notes/release-068.gif>)
...
- When no data is added to Parrot Developer, show dashboard with explicit message: "Requires a metrics view".
- ClickHouse:
