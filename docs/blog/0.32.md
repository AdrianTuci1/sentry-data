...
# Parrot 0.32 -  Level Up Your Data Exploration 📈
...
![release-0 32](https://github.com/staticlabs/statsparrot/assets/5023786/9fa00bbb-f57b-4403-99de-6a412cfeee7e)
...
Export big data at warp speed! Parrot now uses DuckDB’s `COPY TO` statement to execute CSV and Parquet data exports.
...
- **Easy Dashboard Discovery** - Finding your dashboards on Parrot Cloud just got way simpler. The new homepage highlights your dashboards front and center.
...
- **Seamless Data Refresh** - Say goodbye to dashboard downtime during data refresh. Parrot Cloud now updates your data seamlessly behind-the-scenes so your dashboards are always available.

With an array of upgrades both big and small, Parrot 0.32 takes your data exploration to the next level. Try it out and let us know what you think!
