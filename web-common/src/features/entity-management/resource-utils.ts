 ...
 *
 * @example
 * createResourceId({ name: { kind: 'statsparrot.runtime.v1.Model', name: 'orders' } })
 * // Returns: "statsparrot.runtime.v1.Model:orders"
 */
 ...
 *
 * @example
 * parseResourceId("statsparrot.runtime.v1.Model:orders")
 * // Returns: { kind: "statsparrot.runtime.v1.Model", name: "orders" }
 */
 ...
 *
 * @example
 * resourceNameToId({ kind: 'statsparrot.runtime.v1.Model', name: 'orders' })
 * // Returns: "statsparrot.runtime.v1.Model:orders"
 *
