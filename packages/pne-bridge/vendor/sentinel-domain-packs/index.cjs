...
exports.resolveDomainPack = exports.defaultDomainPacks = exports.saasDomainPack = exports.marketingDomainPack = exports.ecommerceDomainPack = void 0;
exports.ecommerceDomainPack = {
    domain: 'ecommerce',
...
exports.defaultDomainPacks = [
    exports.ecommerceDomainPack,
    exports.marketingDomainPack,
    exports.saasDomainPack
];
const resolveDomainPack = (domain) => {
    if (!domain) {
        return undefined;
    }
    return exports.defaultDomainPacks.find((pack) => pack.domain === domain);
};
exports.resolveDomainPack = resolveDomainPack;
