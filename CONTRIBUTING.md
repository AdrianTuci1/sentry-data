...
- [Node.js 22](https://nodejs.org/en/) (we recommend installing it with [nvm](https://github.com/nvm-sh/nvm))
- [Go 1.25](https://go.dev) (on macOS, install with `brew install go`)
