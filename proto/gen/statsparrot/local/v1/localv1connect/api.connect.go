...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/staticlabs/statsparrot/proto/gen/statsparrot/local/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	LocalServiceName = "statsparrot.local.v1.LocalService"
)
...
const (
	...
	LocalServicePingProcedure = "/statsparrot.local.v1.LocalService/Ping"
	// LocalServiceGetMetadataProcedure is the fully-qualified name of the LocalService's GetMetadata
	// RPC.
	LocalServiceGetMetadataProcedure = "/statsparrot.local.v1.LocalService/GetMetadata"
	// LocalServiceGetVersionProcedure is the fully-qualified name of the LocalService's GetVersion RPC.
	LocalServiceGetVersionProcedure = "/statsparrot.local.v1.LocalService/GetVersion"
	// LocalServiceGitStatusProcedure is the fully-qualified name of the LocalService's GitStatus RPC.
	LocalServiceGitStatusProcedure = "/statsparrot.local.v1.LocalService/GitStatus"
	// LocalServiceGithubRepoStatusProcedure is the fully-qualified name of the LocalService's
	// GithubRepoStatus RPC.
	LocalServiceGithubRepoStatusProcedure = "/statsparrot.local.v1.LocalService/GithubRepoStatus"
	// LocalServiceCreateGithubPullRequestProcedure is the fully-qualified name of the LocalService's
	// CreateGithubPullRequest RPC.
	LocalServiceCreateGithubPullRequestProcedure = "/statsparrot.local.v1.LocalService/CreateGithubPullRequest"
	// LocalServiceGetGithubPullRequestProcedure is the fully-qualified name of the LocalService's
	// GetGithubPullRequest RPC.
	LocalServiceGetGithubPullRequestProcedure = "/statsparrot.local.v1.LocalService/GetGithubPullRequest"
	// LocalServiceGitPullProcedure is the fully-qualified name of the LocalService's GitPull RPC.
	LocalServiceGitPullProcedure = "/statsparrot.local.v1.LocalService/GitPull"
	// LocalServiceGitPushProcedure is the fully-qualified name of the LocalService's GitPush RPC.
	LocalServiceGitPushProcedure = "/statsparrot.local.v1.LocalService/GitPush"
	// LocalServicePushToGithubProcedure is the fully-qualified name of the LocalService's PushToGithub
	// RPC.
	LocalServicePushToGithubProcedure = "/statsparrot.local.v1.LocalService/PushToGithub"
	// LocalServiceDeployProjectProcedure is the fully-qualified name of the LocalService's
	// DeployProject RPC.
	LocalServiceDeployProjectProcedure = "/statsparrot.local.v1.LocalService/DeployProject"
	// LocalServiceRedeployProjectProcedure is the fully-qualified name of the LocalService's
	// RedeployProject RPC.
	LocalServiceRedeployProjectProcedure = "/statsparrot.local.v1.LocalService/RedeployProject"
	// LocalServiceGetCurrentUserProcedure is the fully-qualified name of the LocalService's
	// GetCurrentUser RPC.
	LocalServiceGetCurrentUserProcedure = "/statsparrot.local.v1.LocalService/GetCurrentUser"
	// LocalServiceGetCurrentProjectProcedure is the fully-qualified name of the LocalService's
	// GetCurrentProject RPC.
	LocalServiceGetCurrentProjectProcedure = "/statsparrot.local.v1.LocalService/GetCurrentProject"
	...
	LocalServiceListOrganizationsAndBillingMetadataProcedure = "/statsparrot.local.v1.LocalService/ListOrganizationsAndBillingMetadata"
	// LocalServiceCreateOrganizationProcedure is the fully-qualified name of the LocalService's
	// CreateOrganization RPC.
	LocalServiceCreateOrganizationProcedure = "/statsparrot.local.v1.LocalService/CreateOrganization"
	// LocalServiceListMatchingProjectsProcedure is the fully-qualified name of the LocalService's
	// ListMatchingProjects RPC.
	LocalServiceListMatchingProjectsProcedure = "/statsparrot.local.v1.LocalService/ListMatchingProjects"
	// LocalServiceListProjectsForOrgProcedure is the fully-qualified name of the LocalService's
	// ListProjectsForOrg RPC.
	LocalServiceListProjectsForOrgProcedure = "/statsparrot.local.v1.LocalService/ListProjectsForOrg"
	// LocalServiceGetProjectProcedure is the fully-qualified name of the LocalService's GetProject RPC.
	LocalServiceGetProjectProcedure = "/statsparrot.local.v1.LocalService/GetProject"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	localServiceServiceDescriptor                                   = v1.File_statsparrot_local_v1_api_proto.Services().ByName("LocalService")
	...
	localServiceCreateGithubPullRequestMethodDescriptor             = localServiceServiceDescriptor.Methods().ByName("CreateGithubPullRequest")
	localServiceGetGithubPullRequestMethodDescriptor                = localServiceServiceDescriptor.Methods().ByName("GetGithubPullRequest")
...
// LocalServiceClient is a client for the statsparrot.local.v1.LocalService service.
type LocalServiceClient interface {
	...
	CreateGithubPullRequest(context.Context, *connect.Request[v1.CreateGithubPullRequestRequest]) (*connect.Response[v1.CreateGithubPullRequestResponse], error)
	...
	GetGithubPullRequest(context.Context, *connect.Request[v1.GetGithubPullRequestRequest]) (*connect.Response[v1.GetGithubPullRequestResponse], error)
...
// NewLocalServiceClient constructs a client for the statsparrot.local.v1.LocalService service. By
...
func NewLocalServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) LocalServiceClient {
	...
	return &localServiceClient{
		...
		createGithubPullRequest: connect.NewClient[v1.CreateGithubPullRequestRequest, v1.CreateGithubPullRequestResponse](
			httpClient,
			baseURL+LocalServiceCreateGithubPullRequestProcedure,
			connect.WithSchema(localServiceCreateGithubPullRequestMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		getGithubPullRequest: connect.NewClient[v1.GetGithubPullRequestRequest, v1.GetGithubPullRequestResponse](
			httpClient,
			baseURL+LocalServiceGetGithubPullRequestProcedure,
			connect.WithSchema(localServiceGetGithubPullRequestMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
...
type localServiceClient struct {
	...
	createGithubPullRequest             *connect.Client[v1.CreateGithubPullRequestRequest, v1.CreateGithubPullRequestResponse]
	getGithubPullRequest                *connect.Client[v1.GetGithubPullRequestRequest, v1.GetGithubPullRequestResponse]
...
// Ping calls statsparrot.local.v1.LocalService.Ping.
...
// GetMetadata calls statsparrot.local.v1.LocalService.GetMetadata.
...
// GetVersion calls statsparrot.local.v1.LocalService.GetVersion.
...
// GitStatus calls statsparrot.local.v1.LocalService.GitStatus.
...
// GithubRepoStatus calls statsparrot.local.v1.LocalService.GithubRepoStatus.
...
// CreateGithubPullRequest calls statsparrot.local.v1.LocalService.CreateGithubPullRequest.
func (c *localServiceClient) CreateGithubPullRequest(ctx context.Context, req *connect.Request[v1.CreateGithubPullRequestRequest]) (*connect.Response[v1.CreateGithubPullRequestResponse], error) {
	return c.createGithubPullRequest.CallUnary(ctx, req)
}

// GetGithubPullRequest calls statsparrot.local.v1.LocalService.GetGithubPullRequest.
func (c *localServiceClient) GetGithubPullRequest(ctx context.Context, req *connect.Request[v1.GetGithubPullRequestRequest]) (*connect.Response[v1.GetGithubPullRequestResponse], error) {
	return c.getGithubPullRequest.CallUnary(ctx, req)
}

// GitPull calls statsparrot.local.v1.LocalService.GitPull.
...
// GitPush calls statsparrot.local.v1.LocalService.GitPush.
...
// PushToGithub calls statsparrot.local.v1.LocalService.PushToGithub.
...
// DeployProject calls statsparrot.local.v1.LocalService.DeployProject.
...
// RedeployProject calls statsparrot.local.v1.LocalService.RedeployProject.
...
// GetCurrentUser calls statsparrot.local.v1.LocalService.GetCurrentUser.
...
// GetCurrentProject calls statsparrot.local.v1.LocalService.GetCurrentProject.
...
// statsparrot.local.v1.LocalService.ListOrganizationsAndBillingMetadata.
...
// CreateOrganization calls statsparrot.local.v1.LocalService.CreateOrganization.
...
// ListMatchingProjects calls statsparrot.local.v1.LocalService.ListMatchingProjects.
...
// ListProjectsForOrg calls statsparrot.local.v1.LocalService.ListProjectsForOrg.
...
// GetProject calls statsparrot.local.v1.LocalService.GetProject.
...
// LocalServiceHandler is an implementation of the statsparrot.local.v1.LocalService service.
...
func NewLocalServiceHandler(svc LocalServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	localServiceCreateGithubPullRequestHandler := connect.NewUnaryHandler(
		LocalServiceCreateGithubPullRequestProcedure,
		svc.CreateGithubPullRequest,
		connect.WithSchema(localServiceCreateGithubPullRequestMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	localServiceGetGithubPullRequestHandler := connect.NewUnaryHandler(
		LocalServiceGetGithubPullRequestProcedure,
		svc.GetGithubPullRequest,
		connect.WithSchema(localServiceGetGithubPullRequestMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	...
	return "/statsparrot.local.v1.LocalService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		...
		case LocalServiceCreateGithubPullRequestProcedure:
			localServiceCreateGithubPullRequestHandler.ServeHTTP(w, r)
		case LocalServiceGetGithubPullRequestProcedure:
			localServiceGetGithubPullRequestHandler.ServeHTTP(w, r)
...
func (UnimplementedLocalServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.Ping is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) GetMetadata(context.Context, *connect.Request[v1.GetMetadataRequest]) (*connect.Response[v1.GetMetadataResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.GetMetadata is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) GetVersion(context.Context, *connect.Request[v1.GetVersionRequest]) (*connect.Response[v1.GetVersionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.GetVersion is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) GitStatus(context.Context, *connect.Request[v1.GitStatusRequest]) (*connect.Response[v1.GitStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.GitStatus is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) GithubRepoStatus(context.Context, *connect.Request[v1.GithubRepoStatusRequest]) (*connect.Response[v1.GithubRepoStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.GithubRepoStatus is not implemented"))
}

func (UnimplementedLocalServiceHandler) CreateGithubPullRequest(context.Context, *connect.Request[v1.CreateGithubPullRequestRequest]) (*connect.Response[v1.CreateGithubPullRequestResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.CreateGithubPullRequest is not implemented"))
}

func (UnimplementedLocalServiceHandler) GetGithubPullRequest(context.Context, *connect.Request[v1.GetGithubPullRequestRequest]) (*connect.Response[v1.GetGithubPullRequestResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.GetGithubPullRequest is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) GitPull(context.Context, *connect.Request[v1.GitPullRequest]) (*connect.Response[v1.GitPullResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.GitPull is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) GitPush(context.Context, *connect.Request[v1.GitPushRequest]) (*connect.Response[v1.GitPushResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.GitPush is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) PushToGithub(context.Context, *connect.Request[v1.PushToGithubRequest]) (*connect.Response[v1.PushToGithubResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.PushToGithub is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) DeployProject(context.Context, *connect.Request[v1.DeployProjectRequest]) (*connect.Response[v1.DeployProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.DeployProject is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) RedeployProject(context.Context, *connect.Request[v1.RedeployProjectRequest]) (*connect.Response[v1.RedeployProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.RedeployProject is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) GetCurrentUser(context.Context, *connect.Request[v1.GetCurrentUserRequest]) (*connect.Response[v1.GetCurrentUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.GetCurrentUser is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) GetCurrentProject(context.Context, *connect.Request[v1.GetCurrentProjectRequest]) (*connect.Response[v1.GetCurrentProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.GetCurrentProject is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) ListOrganizationsAndBillingMetadata(context.Context, *connect.Request[v1.ListOrganizationsAndBillingMetadataRequest]) (*connect.Response[v1.ListOrganizationsAndBillingMetadataResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.ListOrganizationsAndBillingMetadata is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) CreateOrganization(context.Context, *connect.Request[v1.CreateOrganizationRequest]) (*connect.Response[v1.CreateOrganizationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.CreateOrganization is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) ListMatchingProjects(context.Context, *connect.Request[v1.ListMatchingProjectsRequest]) (*connect.Response[v1.ListMatchingProjectsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.ListMatchingProjects is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) ListProjectsForOrg(context.Context, *connect.Request[v1.ListProjectsForOrgRequest]) (*connect.Response[v1.ListProjectsForOrgResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.ListProjectsForOrg is not implemented"))
}
...
func (UnimplementedLocalServiceHandler) GetProject(context.Context, *connect.Request[v1.GetProjectRequest]) (*connect.Response[v1.GetProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("statsparrot.local.v1.LocalService.GetProject is not implemented"))
}
