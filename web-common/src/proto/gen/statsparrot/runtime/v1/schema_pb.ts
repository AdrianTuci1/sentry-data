...
// @generated from file statsparrot/runtime/v1/schema.proto (package statsparrot.runtime.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message statsparrot.runtime.v1.Type
 */
export class Type extends Message<Type> {
  /**
   * Code designates the type
   *
   * @generated from field: statsparrot.runtime.v1.Type.Code code = 1;
   */
   ...
   *
   * @generated from field: statsparrot.runtime.v1.Type array_element_type = 3;
   */
   ...
   *
   * @generated from field: statsparrot.runtime.v1.StructType struct_type = 4;
   */
   ...
   *
   * @generated from field: statsparrot.runtime.v1.MapType map_type = 5;
   */
  mapType?: MapType;
  ...
  static readonly typeName = "statsparrot.runtime.v1.Type";
 ...
 *
 * @generated from enum statsparrot.runtime.v1.Type.Code
 */
...
proto3.util.setEnumType(Type_Code, "statsparrot.runtime.v1.Type.Code", [
 ...
 *
 * @generated from message statsparrot.runtime.v1.StructType
 */
export class StructType extends Message<StructType> {
  /**
   * @generated from field: repeated statsparrot.runtime.v1.StructType.Field fields = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.runtime.v1.StructType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message statsparrot.runtime.v1.StructType.Field
 */
export class StructType_Field extends Message<StructType_Field> {
  ...
  /**
   * @generated from field: statsparrot.runtime.v1.Type type = 2;
   */
  type?: Type;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.runtime.v1.StructType.Field";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message statsparrot.runtime.v1.MapType
 */
export class MapType extends Message<MapType> {
  /**
   * @generated from field: statsparrot.runtime.v1.Type key_type = 1;
   */
  keyType?: Type;

  /**
   * @generated from field: statsparrot.runtime.v1.Type value_type = 2;
   */
  valueType?: Type;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "statsparrot.runtime.v1.MapType";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
